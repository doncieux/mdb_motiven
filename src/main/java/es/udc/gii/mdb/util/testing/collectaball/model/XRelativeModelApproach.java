 ...
 * @author GII
 */
public class XRelativeModelApproach extends RepresentationApproach {
    ...
    public double[] calculateOutputs(double[] inputs) throws ModelException {
        ...
        double xRelative1 = ModelsCalculations.getxRelative();
        
        xRelative1 = (xRelative1 >= 400.0 ? 400.0 :
                (xRelative1 <= -400.0 ? -400.0 : xRelative1));
        
        xRelative1 = (xRelative1 + 400.0)/800.0;
                
        return new double[]{xRelative1};
